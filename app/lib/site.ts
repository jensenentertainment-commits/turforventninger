export const SITE = {
  ...
  tagline: "Forventningen videreføres.",
  description:
    "Foreningen er etablert for å ivareta foreningens formål, samt opprettholde forventningen om rolige turer i moderat tempo.",
};
